...
public class Main {
    ...
    static io.reactivestax.school.School preSchool= new PreSchool();
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            String studentName = getUserName(input);


            //Student name should have atleast 3 chars and maximum 50 chars
            studentName = getNameLength(sc, studentName);
            ...
            //Grade based on age
            GradeType grade = getGradeOnAge(ageOfStudent);
            ...
            schoolType = getSchoolTypeOnGrade(grade, schoolType);
            ...
            admitStudent(sc, student, school);
            ...
            flag = setFlag(sc, flag, inputUser);

        } while (flag);

    }

    private static boolean setFlag(Scanner sc, boolean flag, String inputUser) {
    ...
    private static void admitStudent(Scanner sc, Student student, School school) {
        try{
    ...
    private static SchoolType getSchoolTypeOnGrade(GradeType grade, SchoolType schoolType) {
        try{
    ...
    private static GradeType getGradeOnAge(int ageOfStudent) {
    ...
    private static String getNameLength(Scanner sc, String studentName) {
